        ...
        Voxel[] GetVoxels()
        {
            ...
            switch (Direction)
            {
                case Axis.X:
                   ...
                   (z == _grid.GridDimensions.z || y == 0) ? null : _grid.Voxels[x, y - 1, z],
                   (z == 0 || y == _grid.GridDimensions.y) ? null : _grid.Voxels[x, y, z - 1],
                   (z == _grid.GridDimensions.z || y == _grid.GridDimensions.y) ? null : _grid.Voxels[x, y, z]
                 };
                case Axis.Y:
                    return new[]
                    {
                   (x == 0 || z == 0) ? null : _grid.Voxels[x - 1, y, z - 1],
                   (x == _grid.GridDimensions.x || z == 0) ? null : _grid.Voxels[x, y, z - 1],
                   (x == 0 || z == _grid.GridDimensions.z) ? null : _grid.Voxels[x - 1, y, z],
                   (x == _grid.GridDimensions.x || z == _grid.GridDimensions.z) ? null : _grid.Voxels[x, y, z]
                };
                case Axis.Z:
                    return new[]
                    {
                   (x == 0 || y == 0) ? null : _grid.Voxels[x - 1, y - 1, z],
                   (x == _grid.GridDimensions.x || y == 0) ? null : _grid.Voxels[x, y - 1, z],
                   (x == 0 || y == _grid.GridDimensions.y) ? null : _grid.Voxels[x - 1, y, z],
                   (x == _grid.GridDimensions.x || y == _grid.GridDimensions.y) ? null : _grid.Voxels[x, y, z]
                };
                default:
                    throw new Exception("Wrong direction.");
            }
